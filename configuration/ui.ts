...
export const CHAT_HEADER: string = `BizGenius: AI assistant for entrepreneurs`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Zoe Z @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `Clear chat`;
export const PAGE_TITLE: string = `BizGenius`;
