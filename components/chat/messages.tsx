...
function AILogo() {
  return (
    <div className="w-9 h-9 relative">
      ...
      />
      <div className="w-2 h-2 rounded-full bg-green-500 absolute -bottom-0.5 -right-0.5 border border-white"></div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ scale: 1.01 }}
        transition={{ type: "spring", stiffness: 300, damping: 20 }}
        className="px-3 py-1 bg-white rounded-2xl text-black max-w-[60%] shadow-sm hover:shadow-md transition-shadow duration-300"
      >
